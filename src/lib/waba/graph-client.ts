 ...
 * ---------------------------------------------------------------------------
 * Cliente HTTP para la Graph API de Meta (WhatsApp Business Platform).
 *
 * Incluye:
 *   - Llamada genérica con timeout, retry y manejo de errores tipados
 *   - Funciones de alto nivel: perfiles, plantillas, mensajes, suscripciones
 *   - Canje del código de Embedded Signup (sin Bearer: credenciales en query)
 *
 * Fuente: export-waba-module/03-CORE/graph-client.ts
 * Adaptación: imports de `WABA_CONFIG` desde `./column-map`
 */

import { WABA_CONFIG } from './column-map';

/* ==========================================================================
 * Tipos de respuesta de Meta
 * ========================================================================== */
...
export class MetaGraphError extends Error {
    ...
    /** ¿El destinatario no existe en WhatsApp? */
...
/** Reintento con backoff exponencial, solo para errores retryable. */
 ...
 * Sin esto, la conexión se guarda pero NO llegan webhooks.
 */
