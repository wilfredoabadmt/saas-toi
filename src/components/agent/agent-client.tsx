 ...
 *
 * Deliberadamente SIN dependencias de librería de componentes externas: sólo React +
 * Tailwind CSS.
 */
  ...
  return (
    ...
    >
      ...
      <Field label="Saludo para conversaciones nuevas">
        <input
          className={inputClass}
          placeholder="Hola, soy el asistente de TOI. ¿En qué te ayudo?"
          value={form.greeting ?? ''}
      ...
      >
        <textarea
          className={inputClass}
          rows={4}
          placeholder={'Transferencia: Cta 100000...\nOficina: Av. Juan Pablo II Nº 30, El Alto'}
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 rounded-lg border border-neutral-800 p-3">
        ...
        <input
          className={inputClass}
          placeholder="¿Tienen cobertura en El Alto?"
          value={question}
        ...
        <textarea
          className={inputClass}
          rows={2}
          placeholder="Sí, con fibra óptica de alta velocidad."
          value={answer}
      ...
      <div className="space-y-2 rounded-lg border border-neutral-800 p-3">
        ...
        <textarea
          className={inputClass}
          rows={3}
          placeholder="Horarios de oficina, zonas de cobertura, políticas de atención…"
          value={block}
