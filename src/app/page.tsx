  ...
  return (
    <div style={{ backgroundColor: '#090d16', color: '#f8fafc', fontFamily: 'system-ui, sans-serif', minHeight: '100vh', lineHeight: 1.6 }}>
      ...
      <nav style={{ borderBottom: '1px solid #1e293b', backgroundColor: 'rgba(9, 13, 22, 0.85)', backdropFilter: 'blur(12px)', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', fontSize: '0.9rem', fontWeight: 600 }}>
            <a href="#features" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Características</a>
            <a href="#pricing" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Precios</a>
            <a href="#faq" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>FAQ</a>
            <Link href="/privacy" style={{ color: 'var(--text-muted)', textDecoration: 'none', fontSize: '0.82rem' }}>Privacidad</Link>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <Link href="/register" style={{ backgroundColor: 'var(--primary-accent)', color: '#ffffff', padding: '0.6rem 1.25rem', borderRadius: '8px', fontWeight: 700, fontSize: '0.9rem', textDecoration: 'none', transition: 'all 0.2s' }}>
              Prueba Gratuita 🚀
            </Link>
          </div>
        </div>
      ...
      <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '5rem 1.5rem 4rem 1.5rem', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#18181B', border: '1px solid #334155', padding: '0.4rem 1rem', borderRadius: '20px', fontSize: '0.82rem', fontWeight: 600, color: '#38bdf8', marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '1.15rem', color: 'var(--text-muted)', maxWidth: '750px', margin: '0 auto 2.5rem auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1.25rem' }}>
          <Link href="/register" style={{ backgroundColor: 'var(--primary-accent)', color: '#ffffff', padding: '0.85rem 2rem', borderRadius: '10px', fontWeight: 800, fontSize: '1.05rem', textDecoration: 'none', boxShadow: '0 10px 25px -5px rgba(37, 99, 235, 0.4)' }}>
            Registrar mi ISP Gratis
          </Link>
          <a href="#features" style={{ backgroundColor: '#18181B', color: '#cbd5e1', border: '1px solid #334155', padding: '0.85rem 2rem', borderRadius: '10px', fontWeight: 700, fontSize: '1.05rem', textDecoration: 'none' }}>
            Ver Demostración
          </a>
        </div>
      </section>
      ...
      {/* Stats KPI Bar */}
      <section style={{ borderTop: '1px solid #1e293b', borderBottom: '1px solid #1e293b', backgroundColor: '#18181B', padding: '2rem 1.5rem' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', textAlign: 'center' }}>
          <div>
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 600 }}>TASA DE MOROSIDAD</div>
          </div>
          <div>
            <div style={{ fontSize: '2rem', fontWeight: 900, color: '#818cf8' }}>100%</div>
            <div style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 600 }}>RECONEXIÓN AUTOMÁTICA</div>
          </div>
          <div>
            <div style={{ fontSize: '2rem', fontWeight: 900, color: '#34d399' }}>AES-256</div>
            <div style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 600 }}>CIFRADO MIKROTIK</div>
          </div>
          <div>
            <div style={{ fontSize: '2rem', fontWeight: 900, color: '#f43f5e' }}>24/7</div>
            <div style={{ color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 600 }}>INBOX MULTI-AGENTE</div>
          </div>
        </div>
      </section>
      ...
      <section id="features" style={{ maxWidth: '1100px', margin: '0 auto', padding: '5rem 1.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1rem' }}>Diseñado para optimizar las operaciones de proveedores de internet de cualquier tamaño</p>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.75rem' }}>
          <div style={{ backgroundColor: '#18181B', border: '1px solid #1e293b', borderRadius: '16px', padding: '2rem' }}>
      ...
      <section id="pricing" style={{ borderTop: '1px solid #1e293b', backgroundColor: '#0b1120', padding: '5rem 1.5rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '1rem' }}>Sin contratos forzosos. Cancela o cambia de plan en cualquier momento.</p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            {/* Start Plan */}
            <div style={{ backgroundColor: '#18181B', border: '1px solid #1e293b', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column' }}>
              <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#38bdf8' }}>START</div>
              <div style={{ fontSize: '2.5rem', fontWeight: 900, color: '#ffffff', margin: '0.75rem 0' }}>$49 <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)', fontWeight: 500 }}>/mes</span></div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '1.5rem' }}>Ideal para pequeños WISPs y proveedores emergentes.</p>
              ...
              <Link href="/register" style={{ marginTop: 'auto', backgroundColor: '#18181B', color: '#ffffff', textAlign: 'center', padding: '0.75rem', borderRadius: '8px', fontWeight: 700, textDecoration: 'none', border: '1px solid #334155' }}>
                Comenzar Prueba
              </Link>
            </div>

            {/* Pro Plan (Featured) */}
            <div style={{ backgroundColor: '#18181B', border: '2px solid #2563eb', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column', position: 'relative' }}>
              <div style={{ position: 'absolute', top: '-14px', right: '20px', backgroundColor: 'var(--primary-accent)', color: '#ffffff', fontSize: '0.75rem', fontWeight: 800, padding: '2px 10px', borderRadius: '10px' }}>MÁS POPULAR</div>
              <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#38bdf8' }}>PRO</div>
              <div style={{ fontSize: '2.5rem', fontWeight: 900, color: '#ffffff', margin: '0.75rem 0' }}>$99 <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)', fontWeight: 500 }}>/mes</span></div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '1.5rem' }}>Para ISPs en rápido crecimiento que requieren automatización total.</p>
              <ul style={{ color: '#cbd5e1', fontSize: '0.9rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.6rem', marginBottom: '2rem' }}>
              ...
              <Link href="/register" style={{ marginTop: 'auto', backgroundColor: 'var(--primary-accent)', color: '#ffffff', textAlign: 'center', padding: '0.75rem', borderRadius: '8px', fontWeight: 700, textDecoration: 'none' }}>
                Comenzar Prueba Pro 🚀
              </Link>
            </div>
            ...
            <div style={{ backgroundColor: '#18181B', border: '1px solid #1e293b', borderRadius: '16px', padding: '2.25rem', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ fontSize: '2.5rem', fontWeight: 900, color: '#ffffff', margin: '0.75rem 0' }}>$199 <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)', fontWeight: 500 }}>/mes</span></div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '1.5rem' }}>Para redes masivas con soporte dedicado.</p>
              <ul style={{ color: '#cbd5e1', fontSize: '0.9rem', paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.6rem', marginBottom: '2rem' }}>
      ...
      <section id="faq" style={{ maxWidth: '900px', margin: '0 auto', padding: '5rem 1.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>Resuelve tus dudas sobre la integración y funcionamiento</p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div style={{ backgroundColor: '#18181B', border: '1px solid #1e293b', borderRadius: '12px', padding: '1.25rem 1.5rem' }}>
      ...
      <footer style={{ borderTop: '1px solid #1e293b', backgroundColor: '#050811', padding: '3rem 1.5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '1.5rem', fontSize: '0.88rem', color: 'var(--text-muted)' }}>
          <div>
          ...
          <div style={{ display: 'flex', gap: '1.5rem' }}>
            ...
            <Link href="/data-deletion" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Eliminación de Datos</Link>
          </div>
        </div>
      </footer>
    </div>
