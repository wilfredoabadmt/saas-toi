  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem 1.5rem', fontFamily: 'system-ui, sans-serif', color: '#0f172a', lineHeight: 1.6 }}>
      ...
      <section style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a' }}>1. Información General</h2>
        ...
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a' }}>2. Datos Recopilados & Uso de WhatsApp Cloud API</h2>
          <p style={{ color: '#334155' }}>
          ...
          <ul style={{ color: '#334155', paddingLeft: '1.25rem' }}>
        ...
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a' }}>3. Protección & Cifrado de Datos</h2>
          <p style={{ color: '#334155' }}>
        ...
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a' }}>4. Derechos del Usuario & Eliminación de Datos</h2>
          <p style={{ color: '#334155' }}>
            Los usuarios pueden solicitar el acceso, rectificación o borrado permanente de sus datos en cualquier momento siguiendo las instrucciones detalladas en nuestra página de <Link href="/data-deletion" style={{ color: '#2563eb', fontWeight: 600 }}>Eliminación de Datos</Link>.
          </p>
        </div>

        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a' }}>5. Contacto</h2>
          <p style={{ color: '#334155' }}>
