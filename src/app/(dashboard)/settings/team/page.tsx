    ...
    <div>
      ...
      <div className="kpi-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
        <div className="kpi-card">
          <div style={{ color: '#64748b', fontSize: '0.82rem', fontWeight: 600 }}>TOTAL EQUIPO</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#0f172a', margin: '0.5rem 0 0.25rem 0' }}>{members.length}</div>
          <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Usuarios activos en tenant</div>
        </div>

        <div className="kpi-card">
          <div style={{ color: '#64748b', fontSize: '0.82rem', fontWeight: 600 }}>ADMINISTRADORES</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#16a34a', margin: '0.5rem 0 0.25rem 0' }}>{adminCount}</div>
          <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Acceso irrestricto</div>
        </div>

        <div className="kpi-card">
          <div style={{ color: '#64748b', fontSize: '0.82rem', fontWeight: 600 }}>COBRANZAS / CAJEROS</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#2563eb', margin: '0.5rem 0 0.25rem 0' }}>{billingCount}</div>
          <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Abonados e Inbox Chat</div>
        </div>

        <div className="kpi-card">
          <div style={{ color: '#64748b', fontSize: '0.82rem', fontWeight: 600 }}>TÉCNICOS DE CAMPO</div>
          <div style={{ fontSize: '2rem', fontWeight: 800, color: '#d97706', margin: '0.5rem 0 0.25rem 0' }}>{techCount}</div>
          <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Módulo de Tickets</div>
        </div>
      </div>
      ...
      <div className="glass-card" style={{ padding: '1.5rem' }}>
        {loading ? (
          <div style={{ padding: '2rem', textAlign: 'center', color: '#94a3b8' }}>Cargando equipo...</div>
        ) : members.length === 0 ? (
          <div style={{ padding: '3rem', textAlign: 'center', color: '#94a3b8' }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>👥</div>
            <p style={{ fontWeight: 600, color: '#64748b' }}>No hay otros usuarios invitados en el equipo.</p>
          </div>
        ) : (
                  ...
                  <tr key={m.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <select
                        ...
                        style={{ padding: '0.35rem 0.6rem', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '0.8rem', outline: 'none' }}
                      >
