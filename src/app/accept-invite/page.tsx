...
function AcceptInviteContent() {
  ...
  return (
    <div style={{ backgroundColor: '#18181B', border: '1px solid #1e293b', borderRadius: '16px', width: '100%', maxWidth: '460px', padding: '2.5rem', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)', textAlign: 'center' }}>
      ...
      <div style={{ backgroundColor: '#18181B', border: '1px solid #334155', padding: '1rem', borderRadius: '8px', margin: '1.5rem 0', fontSize: '0.85rem', color: '#cbd5e1' }}>
...
export default function AcceptInvitePage() {
  return (
    <div style={{ backgroundColor: '#090d16', color: '#f8fafc', fontFamily: 'system-ui, sans-serif', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1.5rem' }}>
      <Suspense fallback={<div style={{ color: 'var(--text-muted)' }}>Cargando invitación...</div>}>
        <AcceptInviteContent />
      </Suspense>
    </div>
  );
