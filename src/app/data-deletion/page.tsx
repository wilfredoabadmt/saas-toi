  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem 1.5rem', fontFamily: 'system-ui, sans-serif', color: 'var(--text-main)', lineHeight: 1.6 }}>
      <header style={{ borderBottom: '2px solid #e2e8f0', paddingBottom: '1.5rem', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>Cumplimiento con los estándares de Meta Graph API / WhatsApp Cloud API</p>
      </header>
      ...
      <section style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div style={{ backgroundColor: 'var(--bg-main)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
          <h2 style={{ fontSize: '1.15rem', fontWeight: 800, color: 'var(--text-main)', margin: '0 0 1rem 0' }}>
            📋 Pasos para solicitar la Eliminación de sus Datos:
          </h2>

          <ol style={{ color: 'var(--text-muted)', paddingLeft: '1.25rem', margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <li>
        ...
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: 'var(--text-main)' }}>Endpoint de Callback para Meta App Review</h2>
          <p style={{ color: 'var(--text-muted)' }}>
